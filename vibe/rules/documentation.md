...
| Product docs | [../../docs/site/content/docs/](../../docs/site/content/docs/) | Upstream product documentation. |
...
- Canonical product facts stay in `docs/` and the published website; `vibe/knowledge/` indexes them instead of copying bodies.
